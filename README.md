...
### حالت نیمه اقتصادی (حدود 120 تا 180 Mbps)
```text
MAX_INFLIGHT=16
MAX_UP_BPS=1310720
MAX_DOWN_BPS=1310720
...
### حالت متعادل (حدود 180 تا 260 Mbps)
```text
MAX_INFLIGHT=24
MAX_UP_BPS=1572864
...
### حالت پایدار شلوغ (حدود 240 تا 320 Mbps)
```text
MAX_INFLIGHT=48
MAX_UP_BPS=1572864
MAX_DOWN_BPS=1572864
...
### حالت پرسرعت (حدود 320 تا 450 Mbps)
```text
MAX_INFLIGHT=128
MAX_UP_BPS=3145728
